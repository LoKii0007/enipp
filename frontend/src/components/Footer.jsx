        ...
        <div className="footer-top grid grid-cols-1 gap-12 justify-center items-center md:grid-cols-2">
          ...
          >
            ...
            <button
              ...
              type="submit"
              className="w-[140px] cursor-pointer py-3 bg-gradient-to-r from-enipp-purple1 to-enipp-purple2 text-black flex justify-center items-center font-bold"
            >
              <div className="z-20">
        ...
        <div className="footer-bottom flex flex-col justify-center items-center pb-4 md:flex-row md:justify-between gap-4 ">
          ...
          <div className="flex gap-5">
            <Link
              ...
              target="_blank"
              className="ig-icon p-2 cursor-pointer "
            >
              <svg
